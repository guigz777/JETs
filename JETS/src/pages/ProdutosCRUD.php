...
<head>
    ...
    <title>Produtos CRUD - Loja de Roupas Jets</title>
    ...
    <main>
        <section class="jets-banner" style="position:relative;">
            ...
            <div class="jets-banner-content">
                <h1 class="banner-title">Produtos Jets (CRUD)</h1>
                <p class="banner-desc">
                    Gerencie sua lista de produtos Jets: adicione, edite ou remova produtos facilmente.
                </p>
            </div>
        </section>
        <?php if ($msg): ?>
